...
// 동점일 경우 I, N, T, P를 우선순위로 둡니다.
const TIE_BREAK_WINNER: Record<Dimension, Letter> = {
  EI: "I",
  SN: "N",
  TF: "T",
  JP: "P",
...
export function calculateMBTI(choices: AnsweredChoice[]): string {
  ...
  return dimensions
    .map((dimension) => {
      ...
      if (scores[first] === scores[second]) {
        return TIE_BREAK_WINNER[dimension];
      }
